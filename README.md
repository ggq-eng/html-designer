...
> **分类**：来源待确认 ｜ **文件数**：15 ｜ **仓库目录**：`html-designer`

## 📌 简介

Expert web graphic designer specializing in HTML/CSS design with
...
```text
  ...
  - **assets/**
    ...
    - design-studio-grid.html
    - designer-portfolio-showcase.html
    - minimalist-services.html
...
```bash
# 用户级（推荐）
cp -r . ~/.workbuddy/skills/html-designer

# 或项目级
cp -r . <你的项目>/.workbuddy/skills/html-designer
```
